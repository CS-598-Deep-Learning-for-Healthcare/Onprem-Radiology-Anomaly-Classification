...
# -----------------------------
# You can swap this to a different DeBERTa checkpoint if desired
...
def save_metrics(metrics_list, model_name: str, num_epochs: int, lr: float):
    ...
    metrics_path = os.path.join(base_dir, "deberta_metrics.csv")
...
# -----------------------------
model.save_pretrained("./deberta_local")
tokenizer.save_pretrained("./deberta_local")

print("Model saved to ./deberta_local")
